  ...
  return (
    <div className="min-h-screen pt-32 pb-12 px-4">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        >
          <h1 className="text-4xl font-bold text-white mb-4">HR</h1>
          <h2 className="text-2xl text-accent mb-8">Establishing Healthy Work Culture </h2>
        </motion.section>
        ...
        >
          ...
          >
            ...
            The Human Resource department is responsible for keeping records of all member's information.
            </p>
          </motion.div>
          <motion.div
            initial={{ x: 50, opacity: 0 }}
          ...
          >
            ...
            It also overlooks the selection process for the chapter each year. It conducts frequent meetings with the core members to ensure the functioning of the chapter is tight and exceeds expectations. The HR department is also responsible for settling any disputes within the chapter for a smooth sailing relationship among the members.
            </p>
          </motion.div>
        </motion.section>
