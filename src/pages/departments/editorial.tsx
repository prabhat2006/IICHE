  ...
  return (
    <div className="min-h-screen pt-32 pb-12 px-4">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        >
          <h1 className="text-4xl font-bold text-white mb-4">Editorial</h1>
          <h2 className="text-2xl text-accent mb-8">Penning Prolific Content</h2>
        </motion.section>
        ...
        >
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed">
              The editorial team of IIChE-VIT is the key for expressing our understanding to the world.
              This domain works on the effective reach of the various events conducted by the chapter, through the power of a pen.
            </p>
          </motion.div>
          <motion.div
            initial={{ x: 50, opacity: 0 }}
          ...
          >
            <p className="text-gray-300">
              This is the platform, where creativity, imagination and powerful thoughts bloom and prosper.
              A chance for the development of writing skills through various forms such as articles, essays, and poems is given to the team.
            </p>
          </motion.div>
        </motion.section>
...
export default EditorialDepartment;