  ...
  return (
    <div className="min-h-screen pt-32 pb-12 px-4">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        >
          <h1 className="text-4xl font-bold text-white mb-4">Technical</h1>
          <h2 className="text-2xl text-accent mb-8">Transforming Ideas Into Reality</h2>
        </motion.section>
        ...
        >
          ...
          >
            ...
            The Technical domain strives hard to transform even the slightest of ideas into pragmatic Technical events that are conducted by IIChE-VIT. 
            </p>
          </motion.div>
          <motion.div
            initial={{ x: 50, opacity: 0 }}
          ...
          >
            ...
            We equip the Chapter’s members to take part in various tech-fests across the country. Nurturing young budding engineers to be cognizant of all the technical aspects behind various chemical processes and discovering every nook and corner of it remains the linchpin of this domain.
            </p>
          </motion.div>
        </motion.section>
